...
function UserRegister() {
  ...
  const onSubmit = async  (dat) => {
    ...
    if(user.userType==="JobSeeker"){
      ...
      const userRegisterUrl="http://localhost:5000/user-api/register";
      try {
      ...
      const recruiterRegisterUrl="http://localhost:5000/recruiter-api/register";
      try {
          ...
          <form className="user-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="register-page-button-container">
              ...
              <p className="already-have-account">
                Already have an account? <Link to={"/login"}><span className="got-to-login-link">Login here</span>
                </Link>
              </p>
            </div>
